# 1 - [Identifying High-risk Breast Cancer Using Digital Pathology Images Phase 1](https://app.nightingalescience.org/contests/3jmp2y128nxd)
...
# Best Solution Approach
    ...
    - For our modelling we tried the following:
        ...
        - We included the dice loss into the training of our network which provided some gains in the performance  
...
You can find more details about both the [dataset creation](project/DataCreation.ipynb) and the modeling, [here](project/ModelingWombcare.ipynb).
